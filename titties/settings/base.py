"""
Django settings for titties project.
...
WSGI_APPLICATION = "titties.wsgi.application"
...
WAGTAIL_SITE_NAME = "Kitties n Titties"
...
WAGTAILADMIN_BASE_URL = "http://www.kittitesntitties.net"
